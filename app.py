...
def get_hod(Branch):
	try:			//(database='dfq8opfmeh8l2t', user = 'qkcbawmiqkysdd', password = '35b198d914d171fc6b1e41079aeaa1753553666bb444a206228d1ae752deb8c6', host = 'ec2-107-22-253-158.compute-1.amazonaws.com', port = '5432')
		connection=psycopg2.connect(user='qkcbawmiqkysdd',password='35b198d914d171fc6b1e41079aeaa1753553666bb444a206228d1ae752deb8c6',host='ec2-174-129-10-235.compute-1.amazonaws.com',port='5432',database='dfq8opfmeh8l2t')
		cursor=connection.cursor()
		cursor.execute("select firstName,lastName from hod where branch=%(b)s",{'b':Branch})
		result=cursor.fetchall()
		print(result)
		if len(result)==0:
			return "AITRBOT: no result found ask properly"
			print("AITRBOT: no result found ask properly")
		else:
			x=result[0][0]+" "+result[0][1]
			return x
			print("AITRBOT:",result[0][0],result[0][1])
	except:
		print("AITRBOT: no result found")
		...
		if len(result)==0:
			...
			if len(mainResult)==0:
				...
				if mainResult[0][2]=='M':
					...
					return x
					print("AITRBOT: He is the "+mainResult[0][0]+" of "+mainResult[0][1]+" branch")
				else: 
